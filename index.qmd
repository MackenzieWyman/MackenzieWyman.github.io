---
title: "Mackenzie Wyman" # change this to your name
...
about:
  ...
  links: 
    - icon: envelope
      text: Contact Me
      href: mailto:mwyman01@hamline.edu # change to your email
    - icon: linkedin
      href: https://linkedin.com. # change to your linkedin address
    - icon: github
      href: https://github.com/MackenzieWyman # change to your github address
    - icon: twitter
